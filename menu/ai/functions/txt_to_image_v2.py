# menu/ai/functions/txt_to_image_v2.py
...
def txt_to_image_v2():
    """Membuat gambar dari teks (prompt) menggunakan AI V2."""
    clear()
    print_cyber_panel("Text to Image V2", "Buat gambar dari deskripsi teks")
    ...
    api_endpoint = f"{base_url}/api/ai/v2/text2img"
    ...
    try:
        ...
        output_filename = f"txt2imgv2_image_{timestamp}.png"
