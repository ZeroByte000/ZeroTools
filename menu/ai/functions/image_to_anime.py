# menu/ai/functions/image_to_anime.py
...
def image_to_anime():
    """Mengubah gambar (lokal atau dari URL) menjadi gaya anime."""
    clear()
    print_cyber_panel("Image to Anime", "Masukkan path gambar atau link URL")
    ...
    if public_url:
        ...
        api_endpoint = f"{base_url}/api/ai/toanime"
